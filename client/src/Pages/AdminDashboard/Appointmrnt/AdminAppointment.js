...
import AdminConfirmAppointment from "./AdminConfirmAppointment";
import AdminRejectAppoitment from "./AdminRejectAppoitment";
  ...
  return (
    ...
    <div>
      <div className="flex gap-5 items-center">
        <div
          className={`border p-2 bg-yellow-500 text-white uppercase cursor-pointer ${
            showPendingAppointments ? "bg-opacity-100" : "bg-opacity-50"
          }`}
          onClick={() => {
            setShowPendingAppointments(true);
            setShowConfirmAppointment(false);
        ...
        <div
          className={`border p-2 bg-green-500 text-white uppercase cursor-pointer ${
            showConfirmAppointment ? "bg-opacity-100" : "bg-opacity-50"
          }`}
          onClick={() => {
            setShowPendingAppointments(false);
            setShowConfirmAppointment(true);
            setShowRejectAppointment(false);
          }}
        >
        ...
        <div
          className={`border p-2 bg-red-500 text-white uppercase cursor-pointer ${
            showRejectAppointment ? "bg-opacity-100" : "bg-opacity-50"
          }`}
          onClick={() => {
            setShowPendingAppointments(false);
            setShowConfirmAppointment(false);
            setShowRejectAppointment(true);
          }}
        >
      ...
      {showConfirmAppointment && <AdminConfirmAppointment />}

      {showRejectAppointment && <AdminRejectAppoitment />}
    </div>
    {/* ... */}
  </div>
  );
