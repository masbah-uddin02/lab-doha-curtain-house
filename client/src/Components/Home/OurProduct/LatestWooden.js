...
const LatestWooden = () => {
    ...
    useEffect(() => {
      ...
      const items = data?.filter(d=>d?.category==="woodenFloor");
  return (
    <div className=" pb-20">
      <div className="flex justify-between mb-5 items-center">
        ...
        <Link to="/products/woodenFloor" className="bg-[#191919] text-[#FFFFFF] border px-5 py-1">
          VIEW MORE
        </Link>
      </div>
